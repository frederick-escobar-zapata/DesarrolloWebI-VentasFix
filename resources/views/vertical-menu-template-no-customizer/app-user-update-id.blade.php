...
{{-- 
  Vista para actualizar usuarios por ID en VentasFix
  
  Esta página permite buscar un usuario específico por ID y luego
  actualizar sus datos. Incluye un diseño de dos columnas:
  - Columna izquierda: Información actual del usuario
...
<html
  ...
  <head>
    ...
    <title>{{ $titulo ?? 'Actualizar Usuario' }} - VentasFix</title>

    {{-- Descripción meta para SEO --}}
    <meta name="description" content="{{ $subtitulo ?? 'Actualización de usuarios del sistema VentasFix' }}" />
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h5 class="card-title mb-0">Actualizar Usuario por ID</h5>
                </div>
                <div class="card-body">
                  <form id="searchByIdForm" method="GET" action="{{ route('usuarios.actualizar-por-id') }}" class="d-flex gap-3 align-items-end">
                    <div class="flex-grow-1">
                      <label for="usuario_id" class="form-label">ID del Usuario a Actualizar</label>
                      <input 
                        type="number" 
                        class="form-control" 
                        id="usuario_id" 
                        name="usuario_id" 
                        placeholder="Ingrese el ID del usuario a actualizar..." 
                    ...
                    <div>
                      <button type="submit" class="btn btn-warning">
                        <i class="ti ti-search me-2"></i>Buscar Usuario
                      </button>
                    </div>
                  </form>
                </div>
              ...
              @if(isset($usuario) && $usuario)
                <!-- Usuario encontrado - Formulario de actualización -->
                <div class="card">
                  <div class="card-header border-bottom">
                    <h5 class="card-title mb-0 text-warning">{{ $titulo ?? 'Actualizar Usuario por ID' }}</h5>
                    <p class="card-text text-muted mt-1">{{ $subtitulo ?? 'Modifique los datos del usuario en el sistema' }}</p>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                        <div class="card border border-info">
                          <div class="card-header bg-label-info">
                            <h6 class="card-title mb-0">Usuario Actual</h6>
                          </div>
                          <div class="card-body">
                            ...
                            <ul class="list-unstyled mb-0">
                              <li class="mb-1"><strong>RUT:</strong> {{ $usuario->rut }}</li>
                              <li class="mb-1"><strong>Email:</strong> {{ $usuario->email }}</li>
                              <li class="mb-0"><strong>Registrado:</strong> {{ $usuario->created_at->format('d/m/Y') }}</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-lg-8 col-md-12">
                        <div class="card border border-warning">
                          ...
                          <div class="card-body">
                            <form method="POST" action="{{ route('usuarios.actualizar-por-id') }}" id="updateUserForm">
                              @csrf
                              @method('POST')
                              ...
                              <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('usuarios.actualizar-por-id') }}" class="btn btn-outline-secondary">
                ...
                <div class="card">
                  <div class="card-body text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                      ...
                      <h5 class="mb-2">Usuario No Encontrado</h5>
                      <p class="text-muted mb-4">No se encontró ningún usuario con el ID: <strong>{{ request('usuario_id') }}</strong></p>
                      <a href="{{ route('usuarios.actualizar-por-id') }}" class="btn btn-warning">
                        <i class="ti ti-search me-2"></i>Buscar Otro Usuario
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div class="card">
                  <div class="card-body text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                      ...
                      <h5 class="mb-2">Actualizar Usuario por ID</h5>
                      <p class="text-muted mb-4">Ingrese el ID del usuario que desea actualizar</p>
                      <div class="alert alert-info d-inline-block" role="alert">
                        <i class="ti ti-info-circle me-2"></i>
                        <strong>Nota:</strong> Podrá modificar todos los datos del usuario encontrado.
                      </div>
                    </div>
                  </div>
                </div>
