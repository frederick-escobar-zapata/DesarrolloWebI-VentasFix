...
<html
  ...
  <head>
    ...
    <title>Dashboard - VentasFix | Sistema de Gestión</title>

    <meta name="description" content="Sistema de gestión VentasFix - Dashboard principal" />
  ...
  <body>
                  ...
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title mb-2">Total Usuarios</h4>
                          <h2 class="text-primary mb-0">{{ $dashboardData['totalUsuarios'] }}</h2>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title mb-2">Total Productos</h4>
                          <h2 class="text-success mb-0">{{ $dashboardData['totalProductos'] }}</h2>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                  <div class="card h-100">
                    <div class="card-body">
                      <div class="d-flex justify-content-between align-items-start">
                        <div>
                          <h4 class="card-title mb-2">Total Clientes</h4>
                          <h2 class="text-warning mb-0">{{ $dashboardData['totalClientes'] }}</h2>
                          <p class="card-text">Clientes registrados</p>
                        </div>
                        <div class="avatar">
                          <span class="avatar-initial rounded bg-label-warning">
                            <i class="ti ti-user-heart ti-26px"></i>
                          </span>
                        </div>
                      </div>
                    </div>
    ...
    <script>
        // Silenciar advertencias de DataTables
        $.fn.dataTable.ext.errMode = 'none';
        
        // Configuración global para DataTables
        $(document).ready(function() {
            // Prevenir errores de inicialización de DataTables
            $('.datatables-projects').on('error.dt', function(e, settings, techNote, message) {
