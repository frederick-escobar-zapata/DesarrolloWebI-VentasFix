                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            ...
                            <p class="mb-0">
                              <span class="me-2">En inventario</span><span class="badge bg-label-success">+{{ $estadisticas['activos'] ?? 0 }}</span>
                            </p>
                          </div>
                          <span class="avatar me-sm-6">
                            <span class="avatar-initial rounded"
                              ><i class="ti-28px ti ti-package text-heading"></i
                            ></span>
                          </span>
                        </div>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            ...
                            <h4 class="mb-1">{{ $estadisticas['activos'] ?? 0 }}</h4>
                            <p class="mb-0">
                              <span class="me-2">Disponibles</span><span class="badge bg-label-success">Activos</span>
                            </p>
                          </div>
                      ...
                      <div class="col-sm-6 col-lg-3">
                        <div
                          ...
                          <div>
                            ...
                            <h4 class="mb-1">{{ $estadisticas['inactivos'] ?? 0 }}</h4>
                            <p class="mb-0">Sin disponibilidad</p>
                          </div>
                          <span class="avatar p-2 me-sm-6">
                            <span class="avatar-initial rounded"><i class="ti-28px ti ti-x text-heading"></i></span>
                          </span>
                        </div>
                      </div>
                      <div class="col-sm-6 col-lg-3">
                        <div class="d-flex justify-content-between align-items-start">
                          <div>
                            <p class="mb-1">Último Mes</p>
                            <h4 class="mb-1">{{ $estadisticas['ultimo_mes'] ?? 0 }}</h4>
                            <p class="mb-0">
                              <span class="me-2">Nuevos productos</span><span class="badge bg-label-info">Recientes</span>
                            </p>
                          </div>
                          <span class="avatar p-2">
                            <span class="avatar-initial rounded"
                              ><i class="ti-28px ti ti-plus text-heading"></i
                            ></span>
                          </span>
                        </div>
                      </div>
