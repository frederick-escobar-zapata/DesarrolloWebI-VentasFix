          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="GET" action="{{ route('usuarios.eliminar-por-id') }}" class="d-flex gap-3 align-items-end">
                    <div class="flex-grow-1">
              ...
              @if(isset($mensaje) && !empty($mensaje))
                <div class="alert alert-{{ isset($usuario) && $usuario ? 'success' : 'warning' }} alert-dismissible fade show" role="alert">
                  <i class="ti ti-{{ isset($usuario) && $usuario ? 'check' : 'alert-circle' }} me-2"></i>
                  {{ $mensaje }}
                    ...
                    <tbody>
                      @if(isset($usuario) && $usuario)
                        <tr>
                          ...
                          <td>
                            <form method="POST" action="{{ route('usuarios.eliminar-por-id.procesar') }}" style="display: inline;">
                              @csrf
                              @method('DELETE')
                        ...
                        <tr>
                          <td colspan="7" class="text-center py-4">
                            <div class="d-flex flex-column align-items-center">
                              ...
                              <p class="text-muted">{{ request('usuario_id') ? 'No se encontró el usuario con ID: ' . request('usuario_id') : 'Busque un usuario por ID para eliminarlo' }}</p>
                            </div>
                          </td>
                        </tr>
                      @endif
