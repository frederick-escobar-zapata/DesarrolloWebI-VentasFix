          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="GET" action="{{ route('usuarios.list-by-id') }}" class="d-flex gap-3 align-items-end">
                    <div class="flex-grow-1">
              ...
              @if(isset($mensaje) && !empty($mensaje))
                <div class="alert alert-{{ $usuarios->count() > 0 ? 'success' : 'warning' }} alert-dismissible fade show" role="alert">
                  <i class="ti ti-{{ $usuarios->count() > 0 ? 'check' : 'alert-circle' }} me-2"></i>
                  {{ $mensaje }}
